...
def render_monthly_report(report: MonthlyReport) -> str:
    ...
    return f"""<div class="monthly-report" data-period="{period}">
<div class="header"><h1>Kiro 企业版月度用量报告</h1>
<div class="report-actions"><span class="powered">Generated by Kiro Script</span>
<button type="button" class="report-export-button" data-export-monthly-report>导出 HTML</button>
</div></div>
